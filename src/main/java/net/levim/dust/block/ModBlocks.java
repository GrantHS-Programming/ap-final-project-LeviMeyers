...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> DUST_LAYER = registerBlock("dust_layer", () -> new SnowLayerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SNOW).sound(SoundType.COBWEB).noCollission()));
